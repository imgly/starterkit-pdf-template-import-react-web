...
For complete integration guides and API reference, visit the [PDF Template Import Documentation](https://img.ly/docs/cesdk/js/starterkits/pdf-template-import-pdf001/).
...
curl -O https://staticimgly.com/imgly/cesdk-web-examples-data/1.82.0-rc.0/starterkit-pdf-template-import/demo-assets.zip
